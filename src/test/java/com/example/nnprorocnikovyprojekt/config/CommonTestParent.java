...
public class CommonTestParent {
    ...
    public Optional<Conversation> getTestConversation() {
    ...
    public List<Message> createTestMessages(User user, Conversation conversation) {
    ...
    public Message getMessage4(User user, Conversation conversation) {
    ...
    public Message getMessage3(User user, Conversation conversation) {
    ...
    public Message getMessage2(User user, Conversation conversation) {
    ...
    public Message getMessage(User user, Conversation conversation) {
